package me.sunlight.sdk.common.widget.titlebar;
...
import me.sunlight.sdk.common.widget.glide.GlideRoundTransform;
 ...
 */
public class CommonTitleBar extends ViewGroup implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        mTvRight.setPadding(context.getResources().getDimensionPixelSize(R.dimen.len_4), context.getResources().getDimensionPixelSize(R.dimen.len_4),
                context.getResources().getDimensionPixelSize(R.dimen.len_4), context.getResources().getDimensionPixelSize(R.dimen.len_4));
        mTvRight.setTextColor(Color.parseColor("#7078f7"));
        mTvRight.setBackgroundDrawable(getResources().getDrawable(R.drawable.title_right_text_selector));
        mTvRight.setVisibility(View.GONE);
        mRightLayout.addView(mTvRight);
     ...
     * 设置标题为图片
     */
    public void setTitleImage(int picId) {
        mCenterLayout.setOrientation(LinearLayout.VERTICAL);
        mCenterImg.setImageResource(picId);
     ...
     * 设置标题为图片
     */
    public void setTitleImage(String picUrl) {
        mCenterLayout.setOrientation(LinearLayout.VERTICAL);
        Glide.with(getContext())
                .load(picUrl)
                .placeholder(R.drawable.default_portrait)
                .error(R.drawable.default_portrait)
                .override(dip2px(38), dip2px(38))
    ...
    /**
     * {@link LinkedList} that holds a list of {@link Action}s.
     */
