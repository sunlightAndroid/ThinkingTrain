...
public abstract class BaseActivity extends AppCompatActivity {
     ...
     * 入口
     */
    public static void runActivity(Context context, Class<? extends BaseActivity> clazz) {
        context.startActivity(new Intent(context, clazz));
    }

    public static void runActivity(Context context, Class<? extends BaseActivity> clazz, Bundle bundle) {
...
//                            | View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION
    ...
    private void setDefaultTitlebar() {
        ...
        mTitleBar.setLeftImageResource(R.drawable.ic_back_gray);
        mTitleBar.setLeftTextColor(getResources().getColor(R.color.black));
