...
public final class PicturesCompressor {
    ...
    public static boolean compressImage(final String srcPath,
                                        ...
                                        Context context) {
        return compressImage(srcPath, savePath, targetSize, 75, 1280, 1280 * 6, null, null, true, context);
    }

    public static File loadWithGlideCache(String path, Context context) {
        File tmp;
        try {
            tmp = Glide.with(context)
                    .load(path)
    ...
    public static boolean compressImage(final String srcPath,
        ...
        if (inTmp.exists()) {
            ...
            File tmp = loadWithGlideCache(srcPath, context);
            if (tmp == null)
                return false;
            sourceFile = tmp;
            loadWithGlide = true;
        ...
        if (loadWithGlide) {
            ...
            realCacheFile = loadWithGlideCache(sourceFile.getAbsolutePath(), context);
